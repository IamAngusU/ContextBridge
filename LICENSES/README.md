...
- The ContextBridge core is AGPL-3.0-only; see the repository-root
  [LICENSE](../LICENSE).
- Reusable integration materials explicitly listed in
  [LICENSING.md](../LICENSING.md) are Apache-2.0; see
