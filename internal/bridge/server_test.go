...
func TestBrowserHeartbeatAndDashboardStatus(t *testing.T) {
	...
	if status.Browser.Tabs[0].LastFailure.Reason != "other" || status.Browser.Tabs[0].LastFailure.LeaseReason != "conversation_changed" || status.Browser.Tabs[0].DOM.InputCharacters != 100000 || !status.Browser.Tabs[0].DOM.InputHasText {
