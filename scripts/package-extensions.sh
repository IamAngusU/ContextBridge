...
for browser in chromium firefox; do
  ...
  cp "$source_dir/popup-live-ui.js" "$target/popup-live-ui.js"
  cp "$source_dir/badge.js" "$target/badge.js"
  cp "$source_dir/wizard.html" "$target/wizard.html"
  cp "$source_dir/wizard.css" "$target/wizard.css"
  cp "$source_dir/wizard.js" "$target/wizard.js"
