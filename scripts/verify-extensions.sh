...
node --check "$root/extension/src/background-entry.js"
node --check "$root/extension/src/browser-recovery.js"
...
node "$root/extension/tests/connect.test.mjs"
...
for browser in chromium firefox; do
  ...
  for file in background.js background-entry.js browser-recovery.js profiles.js picker.js popup.html popup.css popup.js manifest.json icons/icon-16.png icons/icon-32.png icons/icon-48.png icons/icon-128.png icons/contextbridge-mark.webp; do
    test -s "$package/$file" || { echo "Missing $browser/$file" >&2; exit 1; }
  done
  same_file "$root/extension/src/background.js" "$package/background.js"
  same_file "$root/extension/src/background-entry.js" "$package/background-entry.js"
  same_file "$root/extension/src/browser-recovery.js" "$package/browser-recovery.js"
...
grep -q '"service_worker": "background-entry.js"' "$root/extension/chromium/manifest.json"
grep -q '"scripts": \["profiles.js", "background.js", "browser-recovery.js"\]' "$root/extension/firefox/manifest.json"
